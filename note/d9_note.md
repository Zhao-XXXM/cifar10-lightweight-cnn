...
# 为什么加了 Dropout 之后，单 Epoch 的准确率比Day 8的稍低了一点点？
- Dropout 在训练时强行遮挡了 50% 的神经元，这相当于给模型的短跑增加了“负重”。在只训练 1 个 Epoch 时，它的优势还没完全施展；但等到多 Epoch 训练时，这种“负重”将彻底防止过拟合，带来更强的泛化能力。